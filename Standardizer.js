...
(function(window, document, undef) {
	...
	/**
	 * The following immediately invoked function expression checks the native Array object 
	 * for a native implementation of Array#forEach and if it doesn't find one it modifies the Native object
	 * to include a pollyfill which mimics the forEach feature.
	 *
	 * Production steps of ECMA-262, Edition 5, 15.4.4.18
	 * @references 
	 * 		http://es5.github.com/#x15.4.4.18
	 * 		https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/forEach#Compatibility
	 */
	...
	var standardizer = (function(){
		...
		var __standardizer = {
			...
			utilities: {
				...
				/**
				 * This method checks for mouse event support (ideally for checking mouseenter/mouseleave support)
				 * Taken from the great work of @DavidMark and @kangax (http://perfectionkills.com/detecting-event-support-without-browser-sniffing/)
				 * e.g. st.utils.isMouseEventSupported('mouseenter');
				 */
